...
# Add open trades and countdown label
open_trades_label = tk.Label(root, text="Open Trades: 0 | Time to Close: 0s", bg="#001209", fg="white", font=("Helvetica", 12))
open_trades_label.grid(row=2, column=0, columnspan=5, padx=10, pady=5)
...
def update_open_trades_label():
    open_trades_label.config(text=f"Open Trades: {simultaneous_trades} | Time to Close: {countdown_time}s")
    if running:
