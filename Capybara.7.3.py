...
def update_martingale_label():
    if current_amount > initial_amount:
        ...
        martingale_label.config(text="M", fg="#09170d")  # Same color as the background
...
balance_label = tk.Label(root, text="Balance: R$0.00", bg="#09170d", fg="white", font=("Helvetica", 12))
balance_label.grid(row=1, column=1, columnspan=2, padx=5, pady=5)

# Add Martingale label
martingale_label = tk.Label(root, text="M", bg="#09170d", fg="#09170d", font=("Helvetica", 12))
martingale_label.grid(row=1, column=3, padx=5, pady=5)

log_text = ScrolledText(root, height=10, font=("Courier", 10), bg="#09170d", fg="white")
...
profit_label = tk.Label(root, text="Lucro: R$0.00", font=("Helvetica", 16), bg="#09170d", fg="white")
...
amount_label = tk.Label(root, text="Initial Amount:", bg="#09170d", fg="white", font=("Helvetica", 12))
