...
# from pyti.volume_weighted_moving_average import volume_weighted_moving_average as pyti_vwma
...
# from pyti.keltner_channels import keltner_channels as pyti_keltner
from pyti.ultimate_oscillator import ultimate_oscillator as pyti_ultimate
# from pyti.true_strength_index import true_strength_index as pyti_tsi
...
def analyze_indicators(asset):
    ...
    try:
        ...
        available_indicators = {
            ...
            # Remove pyti_trix indicator
            # "pyti_trix": lambda: pyti_trix(data["close"].tolist(), 15)[-1],
            # "pyti_vwma": lambda: pyti_vwma(data["close"].tolist(), data["volume"].tolist(), 20)[-1],
            ...
            # "pyti_keltner_upper": lambda: pyti_keltner(data["high"].tolist(), data["low"].tolist(), data["close"].tolist(), 20)[0][-1],
            # "pyti_keltner_lower": lambda: pyti_keltner(data["high"].tolist(), data["low"].tolist(), data["close"].tolist(), 20)[1][-1],
