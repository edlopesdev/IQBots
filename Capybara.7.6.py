...
def is_high_volatility(asset):
    ...
    return volatility > 0.1  # Increased threshold for high volatility
...
def analyze_indicators(asset):
    ...
    try:
        ...
        if consecutive_losses >= 2:  # Invert votes starting from the third Martingale
            log_message("Terceiro Martingale - Invertendo indicadores")
...
# GUI Configuration
root = tk.Tk()
root.title(f"Capybara v7.6 - Conta: {account_type} - {email}")
