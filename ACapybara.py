...
threading.Thread(target=MartingaleManager.update_on_result, daemon=True).start()
...
def analyze_indicators(asset):
    ...
    # This example assumes random choice; replace with your logic or use external tools if necessary
    from random import choice
    decision = choice(["buy", "sell"])
    log_message(f"Manual analysis decision for {asset}: {decision}")
    return decision
